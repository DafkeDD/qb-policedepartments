...
Config.Locations = {
    ["stations"] = {
        [1] = {
            ...
            colour = 29, 
            coords = vector4(438.67, -981.84, 30.69, 78.29)
        }, -- MRPD
        [2] = {
            label = "Blaine County Sheriffs Office", 
            colour = 31, 
            coords = vector4(-446.34, 6012.56, 32.29, 39.57)
        }, -- Paleto
        [3] = {
            label = "Beaver Bush Station", 
            colour = 2, 
            coords = vector4(386.26, 788.05, 187.51, 313.61)
        }, -- SAPR
    },
}
...
Config.PoliceHelicopter = "VOLPOLMAV"
...
Config.SecurityCameras = {
    ...
    cameras = {
        ...
        [35] = {
            label = "Grape Seed Gas Station", 
            coords = vector3(1705.74, 4916.13, 43.88), 
            r = {x = -35.0, y = 0.0, z = 5.78}, 
            canRotate = true,
            isOnline = true
        },
        [36] = {
            label = "24/7 Supermarkt Popular St CAM#1", 
            coords = vector3(821.7, -778.61, 28.2), 
            r = {x = -35.0, y = 0.0, z = 120.78}, 
            canRotate = true,
            isOnline = true
        },
        [37] = {
            label = "Fleeca Bank Sandy Shores Blvd CAM#1", 
            coords = vector3(1181.24, 2712.49, 39.88), 
            r = {x = -35.0, y = 0.0, z = 120.78}, 
            canRotate = true,
            isOnline = true
        },
        [38] = {
            label = "Maze Bank CAM#1", 
            coords = vector3(-1297.79, -824.88, 20.02), 
            r = {x = -35.0, y = 0.0, z = 90.78}, 
            canRotate = true,
            isOnline = true
        },
    },
